    ...
    public static void main(String[] args) {
        ...
        while (keepsHitting || g.oppSum < 21) {
            ...
            if (sc.hasNextInt()) {
               ...
               System.out.println("Not a number, your turn is forfeited)");
